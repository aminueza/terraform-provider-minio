...
```shell
# IAM LDAP user policy attachments can be imported using the format: user-name/policy-name
terraform import minio_iam_ldap_user_policy_attachment.example user-name/policy-name
```
