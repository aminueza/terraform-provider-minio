...
const (
	errAdminNoSuchUser        = "XMinioAdminNoSuchUser"
	errAddUserInvalidArgument = "XMinioInvalidIAMCredentials"
)
...
//ErrorCodes exports error codes
var ErrorCodes = map[string]*APIError{
	"ErrInvalidCopyDest": {
		Code:           "InvalidRequest",
	...
	"ErrAdminConfigTooLarge": {
		...
		Description:    "Configuration data provided exceeds the allowed maximum of 262272 bytes",
		HTTPStatusCode: http.StatusBadRequest,
	},
